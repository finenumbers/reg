...
10. **Statistics** — `/stats` (admin and operator, `phones:read`) month switcher plus SIP-trunk and platform summary tables. A call that matches several categories is counted in each.
